...
// const InteractionFlowToInteraction = (intFlow: InteractionFlow): Interaction => {
...
// const InputNodeToInputDevice = (device: any): DeviceConfig<InputDevice> => {
//   let deviceType = NameToEnum(device.name);
...
// const OutputNodeToOutputDevice = (device: any): DeviceConfig<OutputDevice> => {
//   let deviceType = NameToEnum(device.name);
